...
# Update Photo Sample
        update_photo_Button = Button(Button_frame_3,text="Update Photo Sample",width=35,font=("time new roman",13,"bold"),bg="blue",fg="white")
    ...
    def add_data(self):
        if self.var_dep.get()== "Select Department" or self.var_std_name.get()=='' or self.var_Stdid.get()=='':
            ...
            try:
                ...
                my_db = mysql.connector.connect(host="localhost",user='root',password='peace@321',database='face_recognition')
